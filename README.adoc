...
* I fixed the many visual bugs (horizon moving and rotating wackily, everything getting overexposed, camera moving lower inside the vehicle) when the first person vehicle camera would roll.
